...
var _arnauorriols$multitaskos$EditableElement$config = function (_p0) {
	var _p1 = _p0;
	return _arnauorriols$multitaskos$EditableElement$Config(
		{stateMsg: _p1.stateMsg, editEnabled: _p1.editEnabled});
};
					...
					return stateMsg(
						A2(
							...
							_arnauorriols$multitaskos$EditableElement$Editing(
								_arnauorriols$multitaskos$EditableElement$Focused(_p2))));
				},
...
var _arnauorriols$multitaskos$EditableElement$getMode = F2(
	function (_p3, state) {
		var _p4 = _p3;
		var _p6 = _p4._0.stateMsg;
		var _p5 = {ctor: '_Tuple2', _0: _p4._0.editEnabled, _1: state};
		if (_p5._0 === true) {
			if (_p5._1.ctor === 'Editing') {
				...
				return _arnauorriols$multitaskos$EditableElement$ReadMode(
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_arnauorriols$multitaskos$EditableElement$triggerEditMode(_p6)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
...
var _arnauorriols$multitaskos$Hotkey$G = {ctor: 'G'};
...
var _arnauorriols$multitaskos$Hotkey$fromChar = function ($char) {
	...
	switch (_p0.valueOf()) {
		...
		case 'g':
			return _elm_lang$core$Maybe$Just(_arnauorriols$multitaskos$Hotkey$G);
		case 'y':
...
var _arnauorriols$multitaskos$Job$viewEmptyJobHelpCard = _arnauorriols$multitaskos$Helpcard$view(
	{
		ctor: '::',
		_0: _arnauorriols$multitaskos$Helpcard$text('Looks like you haven\'t started working on this job yet. Let me give you a few hints to get started:'),
		_1: {
			ctor: '::',
			_0: _arnauorriols$multitaskos$Helpcard$bulletlist(
				{
					ctor: '::',
					_0: _arnauorriols$multitaskos$Helpcard$text('To skip this job and jump to the next job in the queue, click \"SKIP\" or use ALT+S hotkey'),
					_1: {
						ctor: '::',
						_0: _arnauorriols$multitaskos$Helpcard$text('To delete this job altogether, click \"DROP\" or use ALT+R hotkey'),
						_1: {
							ctor: '::',
							_0: _arnauorriols$multitaskos$Helpcard$text('To start working on this job, click \"GO!\" or use ALT+G hotkey'),
							_1: {
								ctor: '::',
								_0: _arnauorriols$multitaskos$Helpcard$bulletlist(
									{
										ctor: '::',
										_0: _arnauorriols$multitaskos$Helpcard$text('When you are working on a job, you can add new entries to its journal. Add as many details as needed, so that you can quickly remember all the context of the job when you get back to it later on. But be careful, remember that you\'ll need to read it all back, do not clog it with unnecessary stuff!'),
										_1: {
											ctor: '::',
											_0: _arnauorriols$multitaskos$Helpcard$markdown('**New!** Now you can write multiple lines in a journal entry, by using shift+enter'),
											_1: {
												ctor: '::',
												_0: _arnauorriols$multitaskos$Helpcard$markdown('**New!** Now you can write using Markdown syntax, check out what you can do [in this cheatsheet](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)'),
												_1: {
													ctor: '::',
													_0: _arnauorriols$multitaskos$Helpcard$text('When you have to stop working on the job, click \"YIELD\" or use ALT+Y. When a job is yielded, it is put back to the end of the queue, and the next job is shown instead'),
													_1: {
														ctor: '::',
														_0: _arnauorriols$multitaskos$Helpcard$text('When you have finished working on the job, click \"FINISH\" or use ALT+C'),
														_1: {ctor: '[]'}
													}
												}
											}
								...
								_1: {
									ctor: '::',
									_0: _arnauorriols$multitaskos$Helpcard$text('Don\'t worry if you have a typo. The title and journal entries are editable, just click on them'),
									_1: {
										ctor: '::',
										_0: _arnauorriols$multitaskos$Helpcard$text('An experimental metrics report is available just by clicking on the graph button at the right. Click it again to switch back to the journal'),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _arnauorriols$multitaskos$Job$updateWorklogEntry = F3(
	function (index, worklogEntry, worklog) {
		var _p0 = A3(_elm_community$list_extra$List_Extra$setAt, index, worklogEntry, worklog);
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
...
var _arnauorriols$multitaskos$Job$editWorklogEntryContent = F3(
	function (index, worklogEntryContent, worklog) {
		var worklogEntryWidgetState = function () {
			var _p1 = A2(_elm_community$list_extra$List_Extra$getAt, index, worklog);
			if (_p1.ctor === 'Just') {
...
var _arnauorriols$multitaskos$Job$updateWorklogEntryWidgetState = F3(
	function (index, worklogEntryWidgetState, worklog) {
		var worklogEntryContent = function () {
			var _p2 = A2(_elm_community$list_extra$List_Extra$getAt, index, worklog);
			if (_p2.ctor === 'Just') {
				return _elm_lang$core$Tuple$first(_p2._0);
			} else {
				return '';
			}
		}();
...
var _arnauorriols$multitaskos$Job$savedWorklog = function (worklog) {
	var _p3 = _elm_lang$core$List$tail(worklog);
	if (_p3.ctor === 'Just') {
		return _p3._0;
	} else {
		return {ctor: '[]'};
...
var _arnauorriols$multitaskos$Job$unsavedWorklogEntry = function (worklog) {
	var _p4 = _elm_lang$core$List$head(worklog);
	if (_p4.ctor === 'Just') {
		return _p4._0;
	} else {
...
var _arnauorriols$multitaskos$Job$viewTitle = function (model) {
	var config = _arnauorriols$multitaskos$EditableElement$config(
		{stateMsg: _arnauorriols$multitaskos$Job$TitleWidget, editEnabled: true});
	...
	return A2(
		...
		function () {
			var _p6 = readOrEditTag;
			if (_p6.ctor === 'ReadMode') {
				return {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$span,
...
var _arnauorriols$multitaskos$Job$viewWorklog = F2(
	function (editable, model) {
		var _p7 = _arnauorriols$multitaskos$Job$savedWorklog(model.worklog);
		if (_p7.ctor === '[]') {
			...
			var renderWorklogEntry = F2(
				function (index, _p8) {
					...
					var config = _arnauorriols$multitaskos$EditableElement$config(
						{
							stateMsg: function (_p10) {
								return _arnauorriols$multitaskos$Job$Worklog(
									A2(_arnauorriols$multitaskos$Job$WorklogEntryWidget, indexCountingUnsavedEntry, _p10));
							},
							editEnabled: editable
						});
					var _p11 = A2(_arnauorriols$multitaskos$EditableElement$getMode, config, _p9._1);
					if (_p11.ctor === 'ReadMode') {
						return A2(
							...
							editable ? {
								ctor: '::',
								_0: _arnauorriols$multitaskos$EditableElement$markdownReadMode(_p13),
								_1: {
									ctor: '::',
			...
			return A2(
				...
				A2(_elm_lang$core$List$indexedMap, renderWorklogEntry, _p7));
		}
	});
var _arnauorriols$multitaskos$Job$Add = {ctor: 'Add'};
var _arnauorriols$multitaskos$Job$viewWorklogForm = F2(
	function (buttonText, _p14) {
		var _p15 = _p14;
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('input-field col s8 m10'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$value(
												_elm_lang$core$Tuple$first(
													_arnauorriols$multitaskos$Job$unsavedWorklogEntry(_p15.worklog))),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(
													function (_p16) {
														return _arnauorriols$multitaskos$Job$Worklog(
															A2(_arnauorriols$multitaskos$Job$Save, 0, _p16));
													}),
												_1: {
													ctor: '::',
													_0: A2(
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('tips: shift+enter, Markdown...'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('input-field col s4 m2'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _arnauorriols$multitaskos$Job$update = F2(
	function (msg, model) {
		...
		switch (_p17.ctor) {
			...
			case 'Focus':
				if (_p17._0.ctor === 'Attempt') {
					var focusTask = _elm_lang$dom$Dom$focus(_p17._0._0);
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(
							...
							function (_p18) {
								return _arnauorriols$multitaskos$Job$Focus(
									_arnauorriols$multitaskos$Job$Result(_p18));
							},
							focusTask)
					};
				} else {
					var _p19 = _p17._0._0;
					if (_p19.ctor === 'Err') {
						var _p20 = A2(_elm_lang$core$Debug$log, 'Element was not found, thus could not be focused', _p19._0._0);
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
					...
					case 'Save':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									worklog: A3(_arnauorriols$multitaskos$Job$editWorklogEntryContent, _p17._0._0, _p17._0._1, model.worklog)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'Delete':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									worklog: A2(_elm_community$list_extra$List_Extra$removeAt, _p17._0._0, model.worklog)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					default:
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									worklog: A3(_arnauorriols$multitaskos$Job$updateWorklogEntryWidgetState, _p17._0._0, _p17._0._1._1, model.worklog)
								}),
							_1: _p17._0._1._0
						};
				}
...
var _arnauorriols$multitaskos$Main$viewInitialHelpCard = _arnauorriols$multitaskos$Helpcard$view(
	{
		ctor: '::',
		_0: _arnauorriols$multitaskos$Helpcard$text('Looks like you are new around here! Let me give you a few hints to get started:'),
		_1: {
			ctor: '::',
			_0: _arnauorriols$multitaskos$Helpcard$bulletlist(
				{
					ctor: '::',
					_0: _arnauorriols$multitaskos$Helpcard$text('The goal of this tool is to help you manage the overhead of doing multiple tasks at the same time'),
					_1: {
						ctor: '::',
						_0: _arnauorriols$multitaskos$Helpcard$text('Tasks in MultitaskOS are called \"jobs\". Click on the button above to create your first job'),
						_1: {
							ctor: '::',
							_0: _arnauorriols$multitaskos$Helpcard$text('New jobs are scheduled to a queue. MultitaskOS will take care of deciding for you which is the next job you have to work on'),
							_1: {
								ctor: '::',
								_0: _arnauorriols$multitaskos$Helpcard$text('Each job has a journal to keep a detailed log of any relevant information you might need when resuming the job later on'),
								_1: {
									ctor: '::',
									_0: _arnauorriols$multitaskos$Helpcard$text('Using the journal, you can dump or load the context of a job at any time. No need to keep it in your head any more!'),
									_1: {
										ctor: '::',
										_0: _arnauorriols$multitaskos$Helpcard$text('Log in to enable cloud synchronization. You will have your data available everywhere!'),
										_1: {
											ctor: '::',
											_0: _arnauorriols$multitaskos$Helpcard$text('Find out about the hotkeys available by clicking on the help icon on the left-bottom corner, or using the ALT+H hotkey'),
											_1: {
												ctor: '::',
												_0: _arnauorriols$multitaskos$Helpcard$text('MultitaskOS is available in the following formats:'),
												_1: {
													ctor: '::',
													_0: _arnauorriols$multitaskos$Helpcard$bulletlist(
														{
															ctor: '::',
															_0: _arnauorriols$multitaskos$Helpcard$markdown('Chrome extension: [Chrome Web Store link](https://chrome.google.com/webstore/detail/multitaskos/ocdlpdmejajjjfcmhggnhbeacmgnabad)'),
															_1: {
																ctor: '::',
																_0: _arnauorriols$multitaskos$Helpcard$markdown('Website: [Website link](https://arnauorriols.github.io/multitaskOS/)'),
																_1: {
																	ctor: '::',
																	_0: _arnauorriols$multitaskos$Helpcard$text('When using Android, make sure to try the \"install to homescreen\" option in Chrome for the best native-like experience'),
																	_1: {ctor: '[]'}
																}
															}
														}),
...
var _arnauorriols$multitaskos$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {jobQueue: a, nextJobStatus: b, hotkeysPressed: c, hintsStatus: d, viewType: e, graphState: f, graphConfig: g};
	});
...
var _arnauorriols$multitaskos$Main$viewNextScheduledJobGraph = function (model) {
	var _p8 = _elm_lang$core$List$head(model.jobQueue);
	if (_p8.ctor === 'Just') {
		return A3(
			_arnauorriols$multitaskos$Graph$view,
			_arnauorriols$multitaskos$Main$graphConfig(model.graphConfig),
			model.graphState,
			_arnauorriols$multitaskos$Metrics$getEvents(_p8._0.history));
	} else {
...
var _arnauorriols$multitaskos$Main$viewViewTypeToggle = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('waves-effect waves-light btn right icon-btn without-margin-btn'),
			_1: {
				ctor: '::',
		...
		return A2(
			...
			function (_p10) {
				return _arnauorriols$multitaskos$Main$NextJob(
					_arnauorriols$multitaskos$Main$NextJobMsg(_p10));
			},
			...
			if (_p11._1.ctor === 'Just') {
				...
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Create your first job'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				};
...
var _arnauorriols$multitaskos$Main$viewNextScheduledJobWorklog = function (model) {
	var _p12 = _elm_lang$core$List$head(model.jobQueue);
	if (_p12.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$map,
			function (_p13) {
				return _arnauorriols$multitaskos$Main$NextJob(
					_arnauorriols$multitaskos$Main$NextJobMsg(_p13));
			},
			A2(
...
var _arnauorriols$multitaskos$Main$metricsConfig = _arnauorriols$multitaskos$Metrics$config(
	{
		...
		toMsg: function (_p16) {
			return _arnauorriols$multitaskos$Main$NextJob(
				_arnauorriols$multitaskos$Main$MetricsMsg(_p16));
		}
	});
var _arnauorriols$multitaskos$Main$encode = function (model) {
	var encodeJobQueue = function (job) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				...
				_0: 'jobQueue',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, encodeJobQueue, model.jobQueue))
			},
			_1: {
				ctor: '::',
				_0: {
...
var _arnauorriols$multitaskos$Main$decoder = function () {
	var jobQueueDecoder = _elm_lang$core$Json_Decode$list(
		A3(
			_elm_lang$core$Json_Decode$map2,
	...
	return A8(
		...
		_arnauorriols$multitaskos$Main$Model,
		...
		_elm_lang$core$Json_Decode$succeed(_arnauorriols$multitaskos$Hotkey$init),
		_elm_lang$core$Json_Decode$succeed(_arnauorriols$multitaskos$Main$Hidden),
		_elm_lang$core$Json_Decode$succeed(_arnauorriols$multitaskos$Main$WorklogView),
		_elm_lang$core$Json_Decode$succeed(_arnauorriols$multitaskos$Graph$init),
		_elm_lang$core$Json_Decode$succeed(_arnauorriols$multitaskos$Main$graphConfigStateInit));
}();
var _arnauorriols$multitaskos$Main$decodeValue = function (value) {
	var _p20 = A2(_elm_lang$core$Json_Decode$decodeValue, _arnauorriols$multitaskos$Main$decoder, value);
	if (_p20.ctor === 'Ok') {
		return _p20._0;
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
		...
		return A2(
			...
			function (_p23) {
				return _arnauorriols$multitaskos$Main$ActiveJob(
					_arnauorriols$multitaskos$Main$ActiveJobMsg(_p23));
			},
			A2(_arnauorriols$multitaskos$Job$viewWorklogForm, submitButtonText, _p22._1._0.data));
	} else {
		return _elm_lang$html$Html$text('');
	}
};
					...
					return {
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A3(_arnauorriols$multitaskos$Main$hotkeyHintOrReal, model.hintsStatus, 'Alt+G', 'Go!')),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
			...
			_0: _arnauorriols$multitaskos$Main$syncModelFromDatabase(
				function (_p25) {
					return _arnauorriols$multitaskos$Main$SyncModel(
						_arnauorriols$multitaskos$Main$decodeValue(_p25));
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					function (_p26) {
						return _arnauorriols$multitaskos$Main$Hotkey(
							_arnauorriols$multitaskos$Main$HotkeyMsg(_p26));
					},
	...
	function (action, model) {
		...
		switch (_p27.ctor) {
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SyncModel':
				return {ctor: '_Tuple2', _0: _p27._0, _1: _elm_lang$core$Platform_Cmd$none};
			case 'NewJob':
				var _p28 = model.nextJobStatus;
				if (_p28.ctor === 'Active') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
			...
			case 'NextJob':
				switch (_p27._0.ctor) {
					...
					case 'Skip':
						...
						if ((((_p29.ctor === '_Tuple2') && (_p29._0.ctor === 'Queued')) && (_p29._1.ctor === 'Just')) && (_p29._1._0.ctor === '_Tuple2')) {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
					...
					case 'Drop':
						...
						if ((((_p30.ctor === '_Tuple2') && (_p30._0.ctor === 'Queued')) && (_p30._1.ctor === 'Just')) && (_p30._1._0.ctor === '_Tuple2')) {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{jobQueue: _p30._1._0._1}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					...
					case 'NextJobMsg':
						var _p31 = _elm_community$list_extra$List_Extra$uncons(model.jobQueue);
						if (_p31.ctor === 'Just') {
							var _p34 = _p31._0._0;
							var _p32 = A2(_arnauorriols$multitaskos$Job$update, _p27._0._0, _p34.data);
							var job2Data = _p32._0;
							var cmd = _p32._1;
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
								...
								_1: A2(
									...
									function (_p33) {
										return _arnauorriols$multitaskos$Main$NextJob(
											_arnauorriols$multitaskos$Main$NextJobMsg(_p33));
									},
									cmd)
							};
						} else {
			...
			case 'ActiveJob':
				switch (_p27._0.ctor) {
					...
					default:
						...
						if ((((_p41.ctor === '_Tuple2') && (_p41._0.ctor === 'Active')) && (_p41._1.ctor === 'Just')) && (_p41._1._0.ctor === '_Tuple2')) {
							var _p44 = _p41._1._0._0;
							var _p42 = A2(_arnauorriols$multitaskos$Job$update, _p27._0._0, _p44.data);
							var job2Data = _p42._0;
							var cmd = _p42._1;
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
								...
								_1: A2(
									...
									function (_p43) {
										return _arnauorriols$multitaskos$Main$ActiveJob(
											_arnauorriols$multitaskos$Main$ActiveJobMsg(_p43));
									},
									cmd)
							};
						} else {
			...
			case 'Hotkey':
				switch (_p27._0.ctor) {
					...
					default:
						var _p47 = A2(_arnauorriols$multitaskos$Hotkey$update, _p27._0._0, model.hotkeysPressed);
						var hotkeysPressed = _p47._0;
						var hotkeyTriggered = _p47._1;
						var modelUpdated = _elm_lang$core$Native_Utils.update(
							model,
							{hotkeysPressed: hotkeysPressed});
						var _p48 = hotkeyTriggered;
						if (_p48.ctor === 'Just') {
							return A3(
								_ccapndave$elm_update_extra$Update_Extra$andThen,
								_arnauorriols$multitaskos$Main$update,
								_arnauorriols$multitaskos$Main$Hotkey(
									_arnauorriols$multitaskos$Main$Triggered(_p48._0)),
			...
			case 'ToggleViewType':
				var _p49 = model.viewType;
				if (_p49.ctor === 'WorklogView') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			default:
				switch (_p27._0.ctor) {
					case 'ChangeResolution':
						...
						var _p50 = _arnauorriols$multitaskos$Graph$dateUnitFromString(_p27._0._0);
						if (_p50.ctor === 'Ok') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
					...
					case 'ChangeOffsetUnit':
						...
						if (_p52.ctor === 'Ok') {
							...
							return _elm_lang$core$Native_Utils.crashCase(
								'Main',
								{
									start: {line: 450, column: 17},
									end: {line: 455, column: 43}
								},
								_p52)(_p52._0);
						}
					default:
													...
													_0: _elm_lang$html$Html_Events$onInput(
														function (_p54) {
															return _arnauorriols$multitaskos$Main$GraphControls(
																_arnauorriols$multitaskos$Main$ChangeOffsetAmmount(_p54));
														}),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(
											...
											_1: {
												...
												_1: {
													...
													_0: _arnauorriols$multitaskos$Utils$onChange(
														function (_p55) {
															return _arnauorriols$multitaskos$Main$GraphControls(
																_arnauorriols$multitaskos$Main$ChangeOffsetUnit(_p55));
														}),
													_1: {ctor: '[]'}
												}
											}
												...
												_1: {
													...
													_1: {
														...
														_0: _arnauorriols$multitaskos$Utils$onChange(
															function (_p56) {
																return _arnauorriols$multitaskos$Main$GraphControls(
																	_arnauorriols$multitaskos$Main$ChangeResolution(_p56));
															}),
														_1: {ctor: '[]'}
													}
												}
	...
	return _arnauorriols$multitaskos$Main$viewPort(
		{
			...
			_0: _arnauorriols$multitaskos$Main$mainSection(
				function () {
					var _p57 = model.viewType;
					if (_p57.ctor === 'WorklogView') {
						return {
							ctor: '::',
							_0: _arnauorriols$multitaskos$Main$viewNextScheduledJobTitle(model),
							_1: {
								ctor: '::',
								_0: _arnauorriols$multitaskos$Main$viewContextSwitchingControls(model),
								_1: {
									ctor: '::',
									_0: _arnauorriols$multitaskos$Main$viewNextScheduledJobWorklog(model),
									_1: {
										ctor: '::',
										_0: _arnauorriols$multitaskos$Main$viewActiveJobWorklogForm(model),
										_1: {
											ctor: '::',
...
var _arnauorriols$multitaskos$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: function (maybeModel) {
			var initialModel = function () {
				var _p58 = maybeModel;
				if (_p58.ctor === 'Just') {
					return _arnauorriols$multitaskos$Main$decodeValue(_p58._0);
				} else {
		...
		update: F2(
			function (msg, oldModel) {
				...
				var trackMetricsCmd = function () {
					var _p59 = {ctor: '_Tuple2', _0: jobTracked, _1: msg};
					_v36_2:
					do {
						if ((_p59.ctor === '_Tuple2') && (_p59._0.ctor === 'Just')) {
							switch (_p59._1.ctor) {
								case 'NextJob':
									if (_p59._1._0.ctor === 'Execute') {
										return A3(_arnauorriols$multitaskos$Metrics$track, _arnauorriols$multitaskos$Main$metricsConfig, _p59._0._0.history, _arnauorriols$multitaskos$Main$StartActivity);
									} else {
										break _v36_2;
									}
								case 'ActiveJob':
									if (_p59._1._0.ctor === 'Yield') {
										return A3(_arnauorriols$multitaskos$Metrics$track, _arnauorriols$multitaskos$Main$metricsConfig, _p59._0._0.history, _arnauorriols$multitaskos$Main$StopActivity);
									} else {
										break _v36_2;
									}
								default:
				...
				var _p60 = A2(_arnauorriols$multitaskos$Main$update, msg, oldModel);
				var newModel = _p60._0;
				var businessCmd = _p60._1;
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: function () {
								var _p61 = model2persist;
								if (_p61.ctor === 'Just') {
									return _arnauorriols$multitaskos$Main$persistModel(
										_arnauorriols$multitaskos$Main$encode(_p61._0));
								} else {
									return _elm_lang$core$Platform_Cmd$none;
								}
							}(),
